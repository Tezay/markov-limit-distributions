...
\paragraph{c) Analyse détaillée par classe (et calcul de leur période\textsuperscript{\ref{lst:compute_period}})}
\mbox{}\hfill\\
...
\begin{minipage}[t]{0.48\textwidth}
    ...
    Classe \textbf{persistante} (finale) et apériodique (période 1).
    \begin{center}
    \begin{tikzpicture}
...
\paragraph{Résultat de la distribution stationnaire $\Pi_{C1}$\textsuperscript{\ref{app:q10_calc}}}
