...
\begin{figure}[H]
  ...
  \caption{Évolution des composantes non nulles $\{6, 17, 20\}$ entre $n=50$ et $n=55$ }
...
\begin{figure}[H]
    ...
    \caption{Évolution des probabilités $\Pi^{(n)}(i)$ pour les états $\{3, 7, 23\}$. Cela confirme la tendance vers zéro de la probabilité d'être dans ces états.}
