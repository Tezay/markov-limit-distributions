...
\end{itemize}
Les résultats numériques (fichiers \texttt{data/q2\_q3/from\_*\_out.txt}) montrent que pour tous ces états, la distribution à \(n=50\) est \textbf{identique} à celle obtenue pour l'état 2 (Question 1).
