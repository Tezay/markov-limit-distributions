...
\begin{figure}[H]
    ...
    \caption{Évolution de la masse de probabilité totale pour la distribution uniforme initiale sur $\{3, 7, 23\}$. Le graphique montre que la masse quitte l'ensemble initial pour s'accumuler dans les ensembles permanents.}
