...
\begin{figure}[H]
  ...
  \caption{Évolution des probabilités pour la classe $\{6, 17, 20\}$ entre $n=50$ et $n=55$ sur une échelle linéaire. Le graphique illustre le cycle déterministe $\mathbf{20 \to 6 \to 17}$ qui se répète fidèlement, confirmant la période $d=3$.}
